...
from app.services.leadconnector import LEADCONNECTOR_API_KEY, LEADCONNECTOR_VERSION, LEADCONNECTOR_API_KEY_PREMIUM_CARS
...
def send_source_id_to_webhook_premium_cars(source_id, contact_id):
    target_host = "services.leadconnectorhq.com"
    target_endpoint = "/hooks/k7RoeQKT06Odv8RoFOjg/webhook-trigger/d6c0ce64-d36b-4d9b-879e-db94588775cd"
